...
<body class="md:bg-etudes-blue">
    <div class="h-screen w-full grid place-items-center">
        <div class="max-w-2xl mx-auto w-full bg-white rounded-xl">
            <div class="text-center mt-2 text-lg text-etudes-blue font-semibold">Ce compte est déjà actif !</div>
            ...
            <div>
                <img src="{{asset('site/assets/login/alreadyconfirmed.png')}}" class="h-96 m-auto cursor-pointer" alt="">
            </div>
        </div>
    </div>
</body>
