@extends('admin.base', [
    'title' => 'Types de domaine',
    'active' => 'domaines',
    'subActive' => 'domaines-type'
])
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Liste des types de domaine</h4>
                <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Ajouter un type de domaine</button>
                <!-- ADD Modal -->
                <div class="modal fade" id="addModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Créer un nouveau type de domaine</h5>
                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                </button>
                            </div>
                            <form action="{{route('admin.domaine.type.store')}}" method="post">
                                @csrf
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="updateModal{{$type->id}}">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.domaine.type.update')}}" method="post">
                                                        @csrf
                                        ...
                                        <div class="modal fade" id="deleteModal{{$type->id}}">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Supprimer un type de domaine</h5>
                                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                                        </button>
                                                    </div>
                                                    <form action="{{route('admin.domaine.type.delete')}}" method="post">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id" value="{{$type->id}}">
                                                            <div class="text-center text-black">
                                                                Êtes vous sûr de vouloir exécuter cette action ? <br/>
                                                                Celle ci supprimera tous les domaine liés à ce type !
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
