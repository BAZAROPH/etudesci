    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Liste des auteurs supprimés</h4>
            </div>
            <div class="card-body">
                                        ...
                                        <div class="modal fade" id="deleteModal{{$author->id}}">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.author.forceDelete')}}" method="post">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <input type="hidden" name="slug" value="{{$author->slug}}">
                                                            <div class="text-center text-black">
                                                                Êtes vous sûr de vouloir exécuter cette action ? <br/>
                                                                Cette action est irréversible et supprimera toute entité liée à cet auteur.
                                                            </div>
                                                        </div>
