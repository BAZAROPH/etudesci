@extends('admin.base', [
    'title' => 'Corbeille des certifications',
    'active' => 'certifications',
    'subActive' => 'certifications-trash'
])
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Corbeille des certifications</h4>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($certifications as $certification)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{$certification->restoreUrl()}}">
                                        ...
                                        <div class="modal fade" id="deleteModal{{$certification->id}}">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.certification.forceDelete')}}" method="post">
                                                        @csrf
