@extends('admin.base', [
    'title' => 'Types de article',
    'active' => 'articles',
    'subActive' => 'articles-type'
])
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Ajouter un type d'article</button>
                <!-- ADD Modal -->
                <div class="modal fade" id="addModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('admin.article.type.store')}}" method="post">
                                @csrf
                                        ...
                                        <div class="modal fade" id="updateModal{{$type->id}}">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.article.type.update')}}" method="post">
                                                        @csrf
                                        ...
                                        <div class="modal fade" id="deleteModal{{$type->id}}">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.article.type.delete')}}" method="post">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id" value="{{$type->id}}">
                                                            <div class="text-center text-black">
                                                                Êtes vous sûr de vouloir exécuter cette action ? <br/>
                                                                Celle ci supprimera tous les articles liés à ce type !
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
